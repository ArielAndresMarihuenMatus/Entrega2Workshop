...
export class PipelineCdkStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: ConsumerProps) {
    ...
    const ecsCodeDeployApp = new codedeploy.EcsApplication(this, "app", { applicationName: 'app' });

    const prodEcsDeploymentGroup = new codedeploy.EcsDeploymentGroup(this, "app-dg", {
      service: props.fargateServiceProd.service,
    ...
    const emailSubscription = new subscriptions.EmailSubscription('marihuen3@gmail.com');
